...
const newRenderAdmin = `function renderAdmin(content) {
            content.innerHTML = \`<div class="fade-in">
                    ...
                    <div class="tabs">
                        <div class="tab" onclick="switchTab(this, 'admin-users')">Gestion des utilisateurs</div>
                        <div class="tab" onclick="switchTab(this, 'admin-access')">Gestion des accès</div>
                        <div class="tab" onclick="switchTab(this, 'admin-dashboards')">Gestion des dashboards</div>
                        <div class="tab" onclick="switchTab(this, 'admin-embeddings')">Gestion des embeddings</div>
                        <div class="tab" onclick="switchTab(this, 'admin-filters')">Configuration des filtres</div>
                        <div class="tab active" onclick="switchTab(this, 'admin-add-dash')">Ajouter un dashboard</div>
                    </div>
                    ...
                    <div id="admin-dashboards" class="hidden">
                        <div class="card" style="padding:32px;">
                    ...
                    <div id="admin-embeddings" class="hidden">
                        <div class="card" style="padding:32px;">
