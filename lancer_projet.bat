...
echo ===================================================================
echo.
echo 1. Lancement de l'API FastAPI (configuration lue dans backend\.env)...
start "Saham API Backend" powershell -NoExit -Command "$env:CORS_ORIGINS='*'; cd backend; uvicorn app.main:app --host 0.0.0.0 --port 8000"
