...
// The block to replace is the whole `<svg>` block
...
const newSvg = `<svg width="100%" height="100%" viewBox="0 0 400 600" preserveAspectRatio="xMidYMid meet" style="opacity:1;">
                                    <path d="${pathData}" fill="#ffffff" stroke="var(--primary-teal)" stroke-width="2" />
                                    <!-- Bubbles -->
                                    <g style="cursor:pointer;" onclick="showToast('Région Tanger: 4.8 Md MAD', 'info')" transform="translate(281.5, 93.7)">
                                        ...
                                        <text x="0" y="2.5" font-family="'Montserrat', sans-serif" font-size="6" font-weight="bold" fill="white" text-anchor="middle">TNG</text>
                                    </g>
                                    <g style="cursor:pointer;" onclick="showToast('Région Rabat: 10.6 Md MAD', 'info')" transform="translate(255.9, 147.0)">
                                        ...
                                        <circle cx="0" cy="0" r="14" fill="rgba(46, 71, 65, 0.8)" stroke="var(--primary-teal)" stroke-width="2"/>
                                        <text x="0" y="2.5" font-family="'Montserrat', sans-serif" font-size="7" font-weight="bold" fill="white" text-anchor="middle">RAB</text>
                                    </g>
                                    <g style="cursor:pointer;" onclick="showToast('Région Casablanca: 22.4 Md MAD', 'info')" transform="translate(237.3, 160.6)">
                                        ...
                                        <circle cx="0" cy="0" r="18" fill="rgba(46, 71, 65, 0.9)" stroke="var(--primary-teal)" stroke-width="2"/>
                                        <text x="0" y="3" font-family="'Montserrat', sans-serif" font-size="8" font-weight="bold" fill="white" text-anchor="middle">CASA</text>
                                    </g>
                                    <g style="cursor:pointer;" onclick="showToast('Région Marrakech: 6.5 Md MAD', 'info')" transform="translate(226.8, 218.6)">
                                        ...
                                        <circle cx="0" cy="0" r="12" fill="rgba(46, 71, 65, 0.8)" stroke="var(--primary-teal)" stroke-width="2"/>
                                        <text x="0" y="2.5" font-family="'Montserrat', sans-serif" font-size="6" font-weight="bold" fill="white" text-anchor="middle">KCH</text>
                                    </g>
